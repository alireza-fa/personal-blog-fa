    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_at', models.DateTimeField(default=datetime.datetime(2023, 1, 24, 12, 3, 27, 688325, tzinfo=datetime.timezone.utc), verbose_name='published at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children', to='blog.postcomment', verbose_name='parent')),
